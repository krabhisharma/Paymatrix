    ...
    <body id="content-body">
         <main id="main-content">  
             ...
             <div>
                ...
                <?php if(mail($_POST['email'],"Hello"." ".$_POST['name'],"Welcome to the coding you registered successfully,this weapplication  provide a platform to develop your knowlege and techinical skills in coding we wish you all the best","From: codingicfai@example.com" . "\r\n" .
                "CC: somebodyelse@example.com"))
                echo "email has been sent";
                else
                echo "email has not sent";?>
                <?php elseif(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['password']) && ($bool === false)):?>
